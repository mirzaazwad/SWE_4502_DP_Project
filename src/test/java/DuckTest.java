...
public class DuckTest {
    ...
    public void TestMarbledDuck(){
        ...
        assertEquals("Ronald, MarbledDuck->Quack",marbledDuck.quack());
    ...
    public void TestMallardDuck(){
        ...
        assertEquals("Donald, MallardDuck->Quack",mallardDuck.quack());
    ...
    public void TestAlabioDuck(){
        ...
        assertEquals("McDonald, AlabioDuck->Quack",alabioDuck.quack());
    ...
    public void TestRubberDuck(){
        ...
        assertEquals("Ducky, RubberDuck->Squeak",rubberDuck.quack());
    ...
    public void WoodenDuck(){
        ...
        assertEquals("Bad Ducky, WoodenDuck->No Sound",woodenDuck.quack());
